...
if ($dropdownValue1 == 'All') {
    $sql = "SELECT * FROM complaintslist WHERE date BETWEEN '$dateValue' AND '$dateValue2' AND type = '$predefinedValue'";
} else {
    $sql = "SELECT * FROM complaintslist WHERE status = '$dropdownValue1' AND date BETWEEN '$dateValue' AND '$dateValue2' AND type = '$predefinedValue'";
}
