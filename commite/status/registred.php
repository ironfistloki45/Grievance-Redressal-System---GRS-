...
$hostel_sql = "SELECT complaintid, type, category, description, date FROM complaintslist WHERE type= '$text'AND status='Registred'";
...
$complaints_sql = "SELECT complaintid, type, category, description,dept, date FROM department WHERE dept = '$text' AND status='Registered'";
