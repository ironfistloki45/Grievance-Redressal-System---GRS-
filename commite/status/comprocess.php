...
$hostel_sql = "SELECT complaintid, type, category, description, date FROM complaintslist WHERE type = '$text'AND status='Viewed by Committee'";
...
$complaints_sql = "SELECT complaintid, type, category, description,dept, date  FROM department WHERE dept = '$text' AND status='Viewed by Committee'";
