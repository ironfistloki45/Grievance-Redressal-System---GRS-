...
$hostel_sql = "SELECT complaintid, type, category, description, date FROM complaintslist WHERE type = '$text'AND status='completed'";
...
$complaints_sql = "SELECT complaintid, type, category, description, date FROM department WHERE dept = '$text' AND status='completed'";
