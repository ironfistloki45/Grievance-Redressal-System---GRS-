...
$hostel_sql = "SELECT complaintid, type, category, description, date ,status FROM complaintslist WHERE type = '$text'";
...
$complaints_sql = "SELECT complaintid, type, category, description, date ,status FROM department WHERE type = '$text'";
