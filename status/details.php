...
$hostel_sql = "SELECT complaintid, type, category, description, date FROM complaintslist WHERE regno = '$text'AND status='Registred'";
...
$complaints_sql = "SELECT complaintid, type, category, description, date FROM department WHERE regno = '$text' AND status='Registered'";
