...
$hostel_sql = "SELECT complaintid, type, category, description, date FROM complaintslist WHERE regno = '$text'AND status='Viewed by Committee'";
...
$complaints_sql = "SELECT complaintid, type,dept,category, description, date  FROM department WHERE regno = '$text' AND status='Viewed by Committee'";
