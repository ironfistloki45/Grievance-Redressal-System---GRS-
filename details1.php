...
$hostel_sql = "SELECT complaintid, type, category, description, date ,status FROM complaintslist WHERE regno = '$text'";
...
$complaints_sql = "SELECT complaintid, type, category, description, date ,status FROM department WHERE regno = '$text'";
